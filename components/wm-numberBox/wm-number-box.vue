<template>
	<view>
		<view class="wm-numbox">
			...
			<input :class="['wm-numbox_value',model==2?'':'wm-numbox_bg']" type="number" :disabled="disabled" :style="{width:height/0.8+'px',height:height+'px',fontSize:height/2+'px', lineHeight: height+'px'}" value="0" v-model="inputValue" @blur="BoxOnBlur"/>
