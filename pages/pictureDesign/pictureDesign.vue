		...
		data(){
			return{
				...
				styles: {
				    ...
				    '世界名家': ['梵高', '康定斯基', '关山月', '吴冠中', '蒙德里安', '葛饰北斋', '毕加索','山形博导', '杜迪拜拉莫夫', '米罗', '莫奈', '克劳斯', '弗朗兹', '穆夏', '齐白石', '塞尚', '杜尚', '达芬奇', '克林姆特', '爱德华蒙克', '波洛克', '永山裕子'],
				    '独特小众': ['灯塔版画', '立体折纸', '赛博朋克', '帆船', '湿拓','铅笔素描', '简笔画','孔雀翎', '简约撞色', '沙画','线描水彩' , '水彩', '线描', '炫彩霓虹', '花与鲸', '几何三原色', '幽莲', '可爱卡通', '波普艺术', '粉色西瓜', '油彩'],
