	...
	export default {
		data(){
			return{
				...
				styles: {
				    '大唐风韵': ['飞天', '金刚', '吴带当风', '辟邪神兽', '唐织锦', '鸟含花锦', '藻井', '唐珐琅', '敦煌壁画', '唐装', '唐三彩', '天王', '门神', '九天阊阖'],
				    '传统文化': ['五彩祥云纹', '戏蝶', '刺绣', '敦煌飞天', '和玺彩画', '明清彩釉', '朝服', '青花瓷', '水墨', '国潮', '唐卡', '凤凰于飞', '剪纸', '藏传唐卡', '瑞鹤图', '水墨工笔', '漆器纹', '工笔白描', '千里江山图', '扎染', '鹿', '九色鹿'],
				    '世界名家': ['梵高', '康定斯基', '关山月', '吴冠中', '蒙德里安', '葛饰北斋', '毕加索','山形博导', '米罗', '莫奈', '穆夏', '齐白石', '塞尚', '杜尚', '达芬奇', '克林姆特', '爱德华蒙克', '波洛克', '杜迪拜拉莫夫', '永山裕子', '克劳斯', '弗朗兹'],
				    '独特小众': ['炫彩霓虹', '立体折纸', '赛博朋克', '帆船', '湿拓','铅笔素描', '简笔画', '沙画','线描水彩' , '水彩', '线描', '灯塔版画', '花与鲸', '几何三原色', '孔雀翎', '幽莲', '简约撞色', '可爱卡通', '波普艺术', '粉色西瓜', '油彩'],
