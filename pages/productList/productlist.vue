		...
		data() {
			return {
				...
				productlistImages: [
				    ...
				    {img: 'https://x-design.oss-cn-hangzhou.aliyuncs.com/product/组 1106@3x.png', name: '明信片', category: 'postcard'},
				    ...
				    {img: 'https://x-design.oss-cn-hangzhou.aliyuncs.com/product/组 1111@3x.png', name: '钥匙扣', category: 'keychain'},
				    {img: 'https://x-design.oss-cn-hangzhou.aliyuncs.com/product/组 1111@3x.png', name: '鼠标垫', category: 'mousePad'},
				    {img: 'https://x-design.oss-cn-hangzhou.aliyuncs.com/product/组 1111@3x.png', name: '卫衣', category: 'sweater'}
				]
			}
		},
