...
<view class="productlist-container">
	<view class="productlist__list">
		...
		<view v-for="key of Object.keys(categoryList)" :key="key" class="productlist__item">
			<image :src="categoryList[key].preview" class="productlist__item__image" @click="chooseCategory(key)"></image>
			<text class="productlist__item__name">{{categoryList[key].name}}</text>
		</view>
	</view>
</view>
</template>
